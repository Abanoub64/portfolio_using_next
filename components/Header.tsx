  ...
  return (
    <header className=" relative z-[999]">
      <motion.div
        ...
        className=" fixed  top-0 left-1/2 h-[4.5rem] w-full border rounded-none border-white border-opacity-40 bg-white  bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem]  sm:top-6 sm:h-[3.25rem]   sm:w-[36rem] sm:rounded-full"
      ></motion.div>
              ...
              >
                ...
                {activeSection === link.name && (
                  <motion.span
                    ...
                    className="  bg-gray-100  -z-10  inset-0 rounded-full absolute"
                  ></motion.span>
                )}
              </Link>
            </motion.li>
